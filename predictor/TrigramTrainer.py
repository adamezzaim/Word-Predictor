...
class TrigramTrainer(object):
    ...
    def stats(self):
        ...
        """
        # TODO: check computation of probabilites
...
def main():
    ...
    parser.add_argument('--laplace', '-ls', action='store_true', default=False, help='apply Laplace smoothing')
    parser.add_argument('--lowercase', '-lc', action='store_true', default=False, help='only lowercase characters')
